...
public class DefaultDecoration {
	...
	private static final Image ERROR_IMAGE = new Image(DefaultDecoration.class.getResource("decoration-error.png").toExternalForm());
	private static final Image WARNING_IMAGE = new Image(DefaultDecoration.class.getResource("decoration-warning.png").toExternalForm());
